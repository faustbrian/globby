 ...
 *
 * Supports standard glob patterns including *, **, ?, and brace expansion.
 * Also provides pattern escaping and dynamic pattern detection.
 *
...
final readonly class PatternMatcher
{
     ...
     * @return array<string> Array of matching absolute paths
     */
     ...
     * @return bool   True if the pattern is dynamic
     */
